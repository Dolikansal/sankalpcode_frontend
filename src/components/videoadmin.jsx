...
const AdminVideo = () => {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      alert(`Deletion Failed: System access denied. ${err}`);
      console.error(err);
    }
  };
    ...
    <div className="min-h-screen bg-[#050505] text-gray-300 font-['Inter',sans-serif]">
      ...
      <main className="max-w-6xl mx-auto p-10">
        ...
        <div className="mb-10">
          ...
          <p className="text-2xl text-white font-light">Video <span className="text-primary font-bold">Delete & Upload of </span> Problems</p>
        </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-[#161b22]/50 text-[10px] text-gray-500 uppercase tracking-widest border-b border-[#30363d]">
                ...
                <th className="px-6 py-4 font-bold text-right">Upload</th>
              </tr>
            </thead>
              ...
              {problems.map((problem, index) => (
                <tr key={problem._id} className="hover:bg-[#161b22]/30 transition-colors group">
                  ...
                  <td className="px-6 py-5 text-right">
                    ...
                    >
                      <Trash2 size={16} />
                      <span className="text-[10px] font-bold uppercase hidden group-hover/btn:block">Uploads</span>
                    </button> */}
